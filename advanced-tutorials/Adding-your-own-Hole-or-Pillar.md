...
The class needs to have some predefined functions to work, and I will go through them one by one. Let's start by creating the class and its `__init__` method:
